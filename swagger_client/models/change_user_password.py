...
class ChangeUserPassword(object):
    ...
    def __init__(self, password=None):  # noqa: E501
        """ChangeUserPassword - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def password(self):
        """Gets the password of this ChangeUserPassword.  # noqa: E501


        :return: The password of this ChangeUserPassword.  # noqa: E501
        :rtype: str
        """
    ...
    def password(self, password):
        """Sets the password of this ChangeUserPassword.


        :param password: The password of this ChangeUserPassword.  # noqa: E501
        :type: str
        """
        if password is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ChangeUserPassword):
            return False
