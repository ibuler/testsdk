...
class OtpVerify(object):
    ...
    def __init__(self, code=None):  # noqa: E501
        """OtpVerify - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this OtpVerify.  # noqa: E501


        :return: The code of this OtpVerify.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this OtpVerify.


        :param code: The code of this OtpVerify.  # noqa: E501
        :type: str
        """
        if code is None:
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OtpVerify):
            return False
